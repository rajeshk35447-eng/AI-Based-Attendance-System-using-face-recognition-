...
class Student:
    def __init__(self,root):
        ...
        # First image
        img = Image.open(r"C:\Users\rajes\OneDrive\Desktop\Face_recoginition system\collage_images\groupimages.avif")
        ...
        # Second image
        img1 = Image.open(r"C:\Users\rajes\OneDrive\Desktop\Face_recoginition system\collage_images\student images1.avif")
        ...
        # Third image
        img2 = Image.open(r"C:\Users\rajes\OneDrive\Desktop\Face_recoginition system\collage_images\images2.jpg")
        img2 = img2.resize((500, 130), Image.LANCZOS)  
        self.photoimage2 = ImageTk.PhotoImage(img2)     
        
        label2 = Label(self.root, image=self.photoimage2)  
        label2.place(x=1000, y=0, width=500, height=130)# bg image
        ...
        img_left = Image.open(r"C:\Users\rajes\OneDrive\Desktop\Face_recoginition system\collage_images\attendance-management.jpg")
        img_left = img_left.resize((720, 130), Image.LANCZOS)  
        self.photoimg_left= ImageTk.PhotoImage(img_left)     
        
        label2 = Label(left_frame, image=self.photoimg_left)  
        label2.place(x=5, y=0, width=720, height=130)
        ...
        dep_combo["values"]=("Select Department","CS&IT","MINING","Bsc Agriculture","Pharmacy","Civil")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","Btech CSE","BCA","MBA","BBA")
        ...
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Button",width=35,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Users\rajes\OneDrive\Desktop\Face_recoginition system\collage_images\Student-Experience-Cover-2-1536x613.jpg")
        img_right= img_right.resize((720, 130), Image.LANCZOS)  
        self.photoimg_right= ImageTk.PhotoImage(img_right)     
        
        label2 = Label(Right_frame, image=self.photoimg_right)  
        label2.place(x=5, y=0, width=720, height=130)
        ...
        Search_combo["values"]=("Roll_No","Phone_No","Email_ID","DOB","Year")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
           messagebox.showerror("Error","All fields are required",parent=self.root)
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Root@123",database="face_recognizer", port=3306)
                my_cursor=conn.cursor()
                my_cursor.execute("""INSERT INTO student 
                     (department, course, year, semester, student_id, name, 
                      division, roll_no, gender, dob, email, phone, 
                      address, teacher, photo_sample) 
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Root@123",database="face_recognizer", port=3306)
        my_cursor=conn.cursor()
        my_cursor.execute("""SELECT department, course, year, semester, student_id, name, 
                             division, roll_no, gender, dob, email, phone, 
                             address, teacher, photo_sample 
                             FROM student""")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    ...
                    # Print for debugging (optional - remove after testing)
                    print("Updating student ID:", self.va_std_id.get())
    ...
    def delete_data(self):
        if self.va_std_id.get()=="":
            messagebox.showerror("Error","Student id mus be required",parent=self.root)
        else:
            try:
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                def face_cropped(img):
                    ...
                    faces=face_classifier.detectMultiScale(gray,1.3,3,5)
                    #scaling facto=1.3
                    #Minimum Neighbour=5
